...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    private Preference multiSelectListPreference(String title, String summary, StringSetting setting) {
        ...
        if (key == Settings.CUSTOM_PROFILE_TABS.key) {
            ...
            entriesValues = new CharSequence[]{"Profile","TwitterBlueNonSubscriber", "Grok","DMs","Communities","Bookmarks","Lists","TopArticles","BirdwatchNotes","Spaces","PendingFollowers","Monetization","ProfessionalToolsGroup","MediaTransparency","Imprint","SettingsAndSupportGroup"};
