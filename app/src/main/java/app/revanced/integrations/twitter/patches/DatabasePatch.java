...
public class DatabasePatch {
    private static Context ctx = app.revanced.integrations.shared.Utils.getContext();
    private static final String[] listItems = app.revanced.integrations.shared.Utils.getResourceStringArray("piko_array_ads_hooks");
